var U=Object.defineProperty;var Z=(r,e,t)=>e in r?U(r,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):r[e]=t;var w=(r,e,t)=>(Z(r,typeof e!="symbol"?e+"":e,t),t);import{css as K,html as X,LitElement as Y}from"https://cdn.jsdelivr.net/gh/lit/dist@2/core/lit-core.min.js";var k=globalThis||{};function g(r,e,t){e instanceof Function&&(t=e,e=document);let i=(e||document).querySelector(r);return t&&i&&i.addEventListener("click",t),i}k.q$=g;function y(r,e,t){e instanceof Function&&(t=e,e=document);let i=(e||document).querySelectorAll(r);return t&&[].slice.apply(i).forEach(t),i}k.q$$=y;var M=document;function z(r,e){let t,i=r,a=!i.tagName;a?(t=M.createElement("textarea"),t.value=i,t.readOnly=!0,t.style.top="0",t.style.left="0",t.style.height="1px",t.style.width="1px",t.style.position="fixed",M.body.appendChild(t)):(t=i,i=t.value),t.setSelectionRange(0,Number.MAX_VALUE),t.select(),setTimeout(()=>{t.focus();try{let s=M.execCommand("copy");e&&e(s)}catch(s){e&&e(!1,s)}a&&M.body.removeChild(t)},50)}function N(r,e){try{navigator.permissions.query({name:"clipboard-write"}).then(t=>{if(t.state!=="granted"&&t.state!=="prompt"){z(r,e);return}let i=navigator.clipboard;if(!i){z(r,e);return}i.writeText(r.value||r||"").then(a=>{e&&e(a)},a=>{z(r,e)})}).catch(t=>{z(r,e)})}catch{z(r,e)}}k.copix=N;async function H(r,e,{api:t,headers:i,streaming:a}){let s=JSON.stringify(r),n=await fetch(t,{method:"POST",mode:"cors",headers:[["Content-Type","application/json"]].concat((i instanceof Function?i():i)||[]),body:s});if(n.status>=400){let o=await n.text();if(o.startsWith("{"))try{let c=JSON.parse(o),{error:p={},err:f=""}=c;f?o=f:typeof p=="string"?o=p:p.message&&(o=p.message)}catch{}e({err:`${n.status}: ${o||n.statusText}: `});return}if(!a){e(await n.json());return}let l=n.body.pipeThrough(new TextDecoderStream).getReader();for(;;){let{value:o,done:c}=await l.read();if(c)break;e(o.split("data: "),a,l.cancel)}}k.po$t=H;function m(r,e){if(e===void 0)return localStorage.getItem(r);if(e===!1){localStorage.removeItem(r);return}localStorage.setItem(r,e)}k.data$=m;var J="[DONE]",E={url:"/chat?stream",streaming:!0,headers:()=>{let r=new URL(`about:blank${location.search}`).searchParams,e=[],t="x-openai",i=m("ik");if(i&&i.length>8&&e.push([`${t}-key`,i]),r.has("vip")){let s=r.get("vip");s&&/^\w{1,16}$/.test(s)&&e.push([`${t}-vip`,s]),r.delete("vip")}let a=r.toString();return a&&e.push([`${t}-args`,btoa(a)]),e},got:(r,e)=>{if(r&&r.err)return{err:r.err};if(!e){let{choices:a=[]}=r||{},{content:s}=a.length>0&&a[0]||{};return s?{cell:{content:s}}:{err:r.error&&r.error.message||"unknown error"}}let t=!1,i=r.map(a=>{if(!a)return"";if(!a.startsWith("{"))return t=a.trim()==J,t?"":a;let s=JSON.parse(a.trim()),{error:n={}}=s;return n.message?(t=-2,`[!ERR] ${n.message}`):s}).map(a=>a?typeof a=="string"?a:a.choices&&a.choices[0].delta.content||"":"").join("");return{fin:t,cell:{content:i}}}};import{css as P,html as h,LitElement as W}from"https://cdn.jsdelivr.net/gh/lit/dist@2/core/lit-core.min.js";var S=/\{\{(\d+)\}\}/g,F=globalThis,A={};function b(r,...e){let t=A||{},i="";if(e.length<=1){i=r.join("");let o=t[i];return!o||e.length===0?i.replace(S,""):(o[e[0]]||i).replace(S,"")}let a=0;r.forEach((o,c)=>{o.length!==0&&(a=c)});let s=e.slice(1,a),n=r.slice(a);if(e.slice(a).forEach((o,c)=>{n.splice(c+1,0,o)}),i=n.join(""),e.length===0)return i.replace(S,"");let l=t[i];return!l||!l[e[0]]?i:l[e[0]].replace(S,(o,c)=>s[parseInt(c,10)]||"")}var T=!1;b.got=(r,e=!1)=>{let t=A||{};Object.keys(r).forEach(i=>{t[i]=t[i]?{...t[i],...r[i]}:{...r[i]}}),A=t,(e||T)&&localStorage.setItem("lib$",JSON.stringify(A))};if(new URL(import.meta.url).searchParams.has("global")){T=!0;let r=localStorage.getItem("lib$");if(r)try{A=JSON.parse(r)}catch{}}F.t$=b;var $="\u275E";b.got({ApiErr:{zh_CN:"\u987B\u6B63\u786E\u8BBE\u7F6Eapi",en_US:"proper api required"},Continue:{zh_CN:"\u7EE7\u7EED"},Remove:{zh_CN:"\u5220\u9664\u6B64\u8BB0\u5F55\uFF1F",en_US:"Remove this log?"},Copy:{zh_CN:"\u62F7\u8D1D"},Delete:{zh_CN:"\u5220\u9664"},Session:{zh_CN:"\u7EED\u804A\u6A21\u5F0F\uFF0C\u9650{{0}}\u5B57\u7B26",en_US:"session continue, limits to {{0}} character(s)"}});var L=class extends W{constructor(){super(),this.lang="zh_CN",this._current=-1}firstUpdated(){let e=this.for&&g(this.for)||this.renderRoot.host.parentNode;this._stage=e,this.api=(e.host||e).api||globalThis.deAPI||E}ask(e,t){let{cells:i=[],api:a=E}=this,s=!isNaN(t)&&t<i.length-1?t:-1;this._current=s,this._asking=e,s>-1&&(i[s].content=e,i[s+1]={role:"assistant",style:"busying",content:$});let n={role:"user",content:e},l=(d,u)=>{this._cancel=void 0,s>-1?(i[s+1]=d,u<0?i[s+1].style="err":delete i[s+1].style):i.push(n,d),this._asking="",this._waiting=[],this.cells=i.slice(0),u!=-1&&this.notify(`de-${u<-1?"new":"changed"}`)},{url:o,streaming:c,headers:p,got:f}=a;if(!o||!f){l({role:"assistant",content:b`${this.lang}ApiErr`},-1);return}this._waiting=[$];let _=i.slice(0,s>-1?s+1:void 0).concat(s===-1?[n]:[]).map(d=>{if(d.style&&delete d.style,!/err/.test(d.role))return d}).filter(d=>!!d);H(_,(d,u,I)=>{this._cancel=I;let{fin:D=!u,err:x,cell:C}=f(d,u),O=typeof D=="number"&&D<0,B=`assistant${x||O?" err":""}`;if(x&&this.renderRoot.host.classList.add("fin"),!u||x){l({role:B,...C,...x?{content:h`[ERR] ${x}`}:{}},x?-2:0);return}let{_waiting:v}=this;v||(v=[]);let j=C&&C.content;if(v.length==0||v[0]==$?v=[j]:v.push(j),D!==!1){l({role:B,...C,content:v.join("")},x||O?-3:0);return}this._waiting=v.slice(0),s>-1&&(i[s+1].content=this._waiting,this.requestUpdate())},{api:o,streaming:c,headers:p})}next(){if(this._waiting&&this._waiting.length>0)return;let{renderRoot:e}=this,t=g("#mysay",e);if(/^\s*$/.test(t.value)){t.focus();return}this.ask(t.value.trim()),this.input("")}input(e){let{renderRoot:t,_tid:i}=this;i&&clearTimeout(i);let a=g("#mysay",t);(e||typeof e=="string")&&(a.value=e.trim()),this._tid=setTimeout(()=>{t.host.classList.contains("fin")||g("#mysay",t).focus()},300)}active(){return this.cells?.length>0||this._waiting?.length>0}notify(e,t){(this._stage.host||this._stage).dispatchEvent(new CustomEvent(e,{detail:t}))}focus(){let{renderRoot:e}=this;this._stage&&this.notify("de-focus",e.host);let t=e.host.classList;t.contains("fin")&&t.remove("fin"),this.input()}_enter(e){e.key=="Enter"&&this.next()}_delete(e){let t=e.target;if(!t.parentElement.classList.contains("err")&&!confirm(b`${this.lang}Remove`))return;let{i:a}=t.dataset,s=parseInt(a,10);this._current>-1&&s<this._current&&(this._current-=1),this.cells.splice(s-1,2),this.cells.length>0?this.requestUpdate():(this._cancel?.(),this.renderRoot.host.parentNode.removeChild(this.renderRoot.host)),this.notify("de-changed")}_edit(e){let t=e.target,{i}=t.dataset,a=parseInt(i,10),s=this.cells[a];!s||(g("#mysay",this.renderRoot).value=s.content,this.focus())}_stop(e){this._cancel()}_regen(e){let t=e.target,{i}=t.dataset,a=parseInt(i,10),s=this.cells[a-1];!s||this.ask(s.content,a-1)}render(){let{max:e=4096}=this.api||{},{cells:t=[],_current:i,_asking:a,_waiting:s,_cancel:n}=this,l=t.length,o=JSON.stringify(t);return h`${l>0?t.map((c,p)=>{let{role:f,content:_,style:d}=c,u=p==l-1&&o.length<e&&!f.includes("err");return h`<div class="${f} ${d||""}">${_===$?h`<div id="dots">${$}</div>`:h`<p>${_}</p>`}${f.includes("assistant")?h`
${n?h`<a class="btn cancel" @click=${this._stop}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="red" class="bi bi-trash3" viewBox="0 0 16 16">
  <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z"/>
  <path d="M5 6.5A1.5 1.5 0 0 1 6.5 5h3A1.5 1.5 0 0 1 11 6.5v3A1.5 1.5 0 0 1 9.5 11h-3A1.5 1.5 0 0 1 5 9.5v-3z"/>
</svg></a>`:p!==i?h`<a class="btn regen" data-i="${p}" @click=${this._regen}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="red" class="bi bi-trash3" viewBox="0 0 16 16">
  <path fill-rule="evenodd" d="M8 3a5 5 0 1 1-4.546 2.914.5.5 0 0 0-.908-.417A6 6 0 1 0 8 2v1z"/>
  <path d="M8 4.466V.534a.25.25 0 0 0-.41-.192L5.23 2.308a.25.25 0 0 0 0 .384l2.36 1.966A.25.25 0 0 0 8 4.466z"/>
</svg></a>`:""}
              <a class="btn trash ${u?"":"r2"}" title="${b`${this.lang}Delete`}" data-i="${p}" @click=${this._delete}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="red" class="bi bi-trash3" viewBox="0 0 16 16">
  <path d="M6.5 1h3a.5.5 0 0 1 .5.5v1H6v-1a.5.5 0 0 1 .5-.5ZM11 2.5v-1A1.5 1.5 0 0 0 9.5 0h-3A1.5 1.5 0 0 0 5 1.5v1H2.506a.58.58 0 0 0-.01 0H1.5a.5.5 0 0 0 0 1h.538l.853 10.66A2 2 0 0 0 4.885 16h6.23a2 2 0 0 0 1.994-1.84l.853-10.66h.538a.5.5 0 0 0 0-1h-.995a.59.59 0 0 0-.01 0H11Zm1.958 1-.846 10.58a1 1 0 0 1-.997.92h-6.23a1 1 0 0 1-.997-.92L3.042 3.5h9.916Zm-7.487 1a.5.5 0 0 1 .528.47l.5 8.5a.5.5 0 0 1-.998.06L5 5.03a.5.5 0 0 1 .47-.53Zm5.058 0a.5.5 0 0 1 .47.53l-.5 8.5a.5.5 0 1 1-.998-.06l.5-8.5a.5.5 0 0 1 .528-.47ZM8 4.5a.5.5 0 0 1 .5.5v8.5a.5.5 0 0 1-1 0V5a.5.5 0 0 1 .5-.5Z"/>
</svg></a>${u?h`<a class="btn continue" title="${b`${this.lang}Continue`} " @click=${()=>this.focus()}>
<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-chat-square-quote-fill" viewBox="0 0 16 16">
  <path d="M0 2a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2h-2.5a1 1 0 0 0-.8.4l-1.9 2.533a1 1 0 0 1-1.6 0L5.3 12.4a1 1 0 0 0-.8-.4H2a2 2 0 0 1-2-2V2zm7.194 2.766a1.688 1.688 0 0 0-.227-.272 1.467 1.467 0 0 0-.469-.324l-.008-.004A1.785 1.785 0 0 0 5.734 4C4.776 4 4 4.746 4 5.667c0 .92.776 1.666 1.734 1.666.343 0 .662-.095.931-.26-.137.389-.39.804-.81 1.22a.405.405 0 0 0 .011.59c.173.16.447.155.614-.01 1.334-1.329 1.37-2.758.941-3.706a2.461 2.461 0 0 0-.227-.4zM11 7.073c-.136.389-.39.804-.81 1.22a.405.405 0 0 0 .012.59c.172.16.446.155.613-.01 1.334-1.329 1.37-2.758.942-3.706a2.466 2.466 0 0 0-.228-.4 1.686 1.686 0 0 0-.227-.273 1.466 1.466 0 0 0-.469-.324l-.008-.004A1.785 1.785 0 0 0 10.07 4c-.957 0-1.734.746-1.734 1.667 0 .92.777 1.666 1.734 1.666.343 0 .662-.095.931-.26z"/>
          ...
          </a>`:""}<a class="btn copix" title="${b`${this.lang}Copy`}" @click=${()=>{N(_)}}></a>`:f.includes("user")?h`<a class="btn edit" data-i="${p}" @click=${this._edit}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
  <path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z"/>
  <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z"/>
</svg></a>`:""}</div>`}):""}${i===-1&&a?h`<div class="user"><p>${a}</p></div>`:""}${i===-1&&s&&s.length>0?h`<div class="assistant">${s[0]===$?h`<div id="dots">${s}</div>`:h`<p>${s}</p>`}</div>`:""}<div class="next ${l>0?"has":""}">
      <input autofocus type="search" id="mysay" class="rl" @keypress=${this._enter} placeholder="${l>0?b`${this.lang}${e-o.length}Session`:""}">
...
<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-return-left" viewBox="0 0 16 16">
  <path fill-rule="evenodd" d="M14.5 1.5a.5.5 0 0 1 .5.5v4.8a2.5 2.5 0 0 1-2.5 2.5H2.707l3.347 3.346a.5.5 0 0 1-.708.708l-4.2-4.2a.5.5 0 0 1 0-.708l4-4a.5.5 0 1 1 .708.708L2.707 8.3H12.5A1.5 1.5 0 0 0 14 6.8V2a.5.5 0 0 1 .5-.5z"/>
    ...
    </div>`}};w(L,"properties",{cells:{type:Array},api:{type:Object},lang:{type:String},for:{type:String},_tid:{type:Object},_current:{type:Number},_asking:{type:String},_waiting:{type:Array},_stage:{type:HTMLElement}}),w(L,"styles",P`
  :host {
    display: block;
    font-size: 1rem;
    padding-top: 2rem;
  ...
  `);customElements.define("de-chat",L);var q=document,V=q.createElement("a"),R=class extends Y{constructor(){super(),this._available=!0,this._ik=m("ik"),this.api=E}firstUpdated(){let e=this.renderRoot.host;e.addEventListener("de-changed",()=>{let i=[];y("de-chat",this.renderRoot,a=>{a.cells?.length>0&&i.push(a.cells)}),m("ai",JSON.stringify(i)),this._available=i.length>0}),e.addEventListener("de-new",()=>{this.new()});let t=m("ai");t?this.load(t):this._available=!1,e.addEventListener("de-focus",i=>{y("de-chat",this.renderRoot,a=>{a!=i.detail&&a.classList.add("fin")})}),this.new(),window.addEventListener("beforeunload",i=>{let a=!1;if(y("de-chat",this.renderRoot,s=>{a||s._waiting&&s._waiting.length>0&&(a=!0)}),a)return i.preventDefault(),i.returnValue="\u8FD8\u6709\u5BF9\u8BDD\u6CA1\u6709\u7ED3\u675F\uFF0C\u786E\u5B9A\u79BB\u5F00\uFF1F"},{capture:!0})}load(e){try{let t=JSON.parse(e);if(!t||t.length==0)return!1;let i=g("#ia",this.renderRoot),a=i.previousElementSibling;return a&&!a.active()&&(i=a),t.forEach(s=>{let n=q.createElement("de-chat");n.className="fin",n.cells=s,this.renderRoot.insertBefore(n,i)}),this._available=!0,!0}catch(t){console.error(t)}return!1}new(){let e=g("#ia",this.renderRoot),t=e.previousElementSibling;if(!t||t.active()){let i=q.createElement("de-chat");this.renderRoot.insertBefore(i,e),t=i}t.focus()}_local(e){let t=prompt(`\u4F7F\u7528\u81EA\u5DF1\u7684OpenAI Key
  \u3010\u6CE8\u610F\u3011\u672C\u7AD9\u4E0D\u5B58\u50A8\uFF0C\u98CE\u9669\u81EA\u8D1F\u3002\uFF08\u5EFA\u8BAE\u5B58\u670D\u52A1\u5668\uFF09`);if(!!t){if(t==="CLEAR"){m("ik",!1),this._ik="";return}this._ik=btoa(t.trim()),m("ik",btoa(t.trim()))}}clear(){!m("ai")||!confirm("\u786E\u8BA4\u8981\u6E05\u9664\u6240\u6709\u8BB0\u5F55\uFF1F")||(y("de-chat",this.renderRoot,e=>{!e.active()||e.parentNode.removeChild(e)}),m("ai",!1),this._available=!1,this.new())}_loadx=e=>{let t=e.target.files;if(!window.FileReader||!t||t.length==0)return;let i=new FileReader;i.onload=a=>{let s=a.target.result;this.load(s)&&this.renderRoot.host.dispatchEvent(new CustomEvent("de-changed",{})),this.new()},i.readAsText(t[0])};download(){let e=m("ai");if(!e){alert("\u6CA1\u6709\u8BB0\u5F55\u6570\u636E");return}let t=new Date;V.download=`deqi-ai-chat_${[t.getFullYear(),`0${t.getMonth()+1}`.slice(-2),`0${t.getDate()}`.slice(-2)].join("")}.json`,V.href=`data:application/json;base64,${btoa(unescape(encodeURIComponent(e)))}`,V.click()}render(){return X`<div id="ia" style="text-align: center;position:relative;display: flex; align-items: center;">
...
</div><input id="myfile" type="file" accept=".json" style="display:none" @change=${this._loadx}>`}};w(R,"properties",{api:{type:Object},_available:{type:Boolean},_ik:{type:String}}),w(R,"styles",K`
:host {
  display: block;
  width: 100%;
  margin: 2rem auto;
