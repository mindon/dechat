var U=Object.defineProperty;var Z=(r,e,t)=>e in r?U(r,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):r[e]=t;var _=(r,e,t)=>(Z(r,typeof e!="symbol"?e+"":e,t),t);import{css as K,html as X,LitElement as Y}from"https://cdn.jsdelivr.net/gh/lit/dist@2/core/lit-core.min.js";var z=globalThis||{};function p(r,e,t){e instanceof Function&&(t=e,e=document);let i=(e||document).querySelector(r);return t&&i&&i.addEventListener("click",t),i}z.q$=p;function k(r,e,t){e instanceof Function&&(t=e,e=document);let i=(e||document).querySelectorAll(r);return t&&[].slice.apply(i).forEach(t),i}z.q$$=k;var D=document;function A(r,e){let t,i=r,a=!i.tagName;a?(t=D.createElement("textarea"),t.value=i,t.readOnly=!0,t.style.top="0",t.style.left="0",t.style.height="1px",t.style.width="1px",t.style.position="fixed",D.body.appendChild(t)):(t=i,i=t.value),t.setSelectionRange(0,Number.MAX_VALUE),t.select(),setTimeout(()=>{t.focus();try{let s=D.execCommand("copy");e&&e(s)}catch(s){e&&e(!1,s)}a&&D.body.removeChild(t)},50)}function H(r,e){try{navigator.permissions.query({name:"clipboard-write"}).then(t=>{if(t.state!=="granted"&&t.state!=="prompt"){A(r,e);return}let i=navigator.clipboard;if(!i){A(r,e);return}i.writeText(r.value||r||"").then(a=>{e&&e(a)},a=>{A(r,e)})}).catch(t=>{A(r,e)})}catch{A(r,e)}}z.copix=H;async function V(r,e,{api:t,headers:i,streaming:a}){let s=JSON.stringify(r),l=z.AbortController?new AbortController:{},h=l.signal,o=await fetch(t,{method:"POST",signal:h,mode:"cors",headers:[["Content-Type","application/json"]].concat((i instanceof Function?i():i)||[]),body:s});if(o.status>=400){let n=await o.text();if(n.startsWith("{"))try{let c=JSON.parse(n),{error:y={},err:$=""}=c;$?n=$:typeof y=="string"?n=y:y.message&&(n=y.message)}catch{}e({err:`${o.status}: ${n||o.statusText}: `});return}if(!a){e(await o.json());return}let b=o.body.pipeThrough(new TextDecoderStream).getReader(),f=!1,x=()=>{l.abort?.(),f=!0};for(;!f;){let{value:n,done:c}=await b.read();if(c)break;e(n.split("data: "),a,x)}}z.po$t=V;function g(r,e){if(e===void 0)return localStorage.getItem(r);if(e===!1){localStorage.removeItem(r);return}localStorage.setItem(r,e)}z.data$=g;var J="[DONE]",L={url:"/chat?stream",streaming:!0,headers:()=>{let r=new URL(`about:blank${location.search}`).searchParams,e=[],t="x-openai",i=g("ik");if(i&&i.length>8&&e.push([`${t}-key`,i]),r.has("vip")){let s=r.get("vip");s&&/^\w{1,16}$/.test(s)&&e.push([`${t}-vip`,s]),r.delete("vip")}let a=r.toString();return a&&e.push([`${t}-args`,btoa(a)]),e},got:(r,e)=>{if(r&&r.err)return{err:r.err};if(!e){let{choices:a=[]}=r||{},{content:s}=a.length>0&&a[0]||{};return s?{cell:{content:s}}:{err:r.error&&r.error.message||"unknown error"}}let t=!1,i=r.map(a=>{if(!a)return"";if(!a.startsWith("{"))return t=a.trim()==J,t?"":a;let s=JSON.parse(a.trim()),{error:l={}}=s;return l.message?(t=-2,`[!ERR] ${l.message}`):s}).map(a=>a?typeof a=="string"?a:a.choices&&a.choices[0].delta.content||"":"").join("");return{fin:t,cell:{content:i}}}};import{css as P,html as d,LitElement as W}from"https://cdn.jsdelivr.net/gh/lit/dist@2/core/lit-core.min.js";var N=/\{\{(\d+)\}\}/g,F=globalThis,C={};function u(r,...e){let t=C||{},i="";if(e.length<=1){i=r.join("");let o=t[i];return!o||e.length===0?i.replace(N,""):(o[e[0]]||i).replace(N,"")}let a=0;r.forEach((o,m)=>{o.length!==0&&(a=m)});let s=e.slice(1,a),l=r.slice(a);if(e.slice(a).forEach((o,m)=>{l.splice(m+1,0,o)}),i=l.join(""),e.length===0)return i.replace(N,"");let h=t[i];return!h||!h[e[0]]?i:h[e[0]].replace(N,(o,m)=>s[parseInt(m,10)]||"")}var I=!1;u.got=(r,e=!1)=>{let t=C||{};Object.keys(r).forEach(i=>{t[i]=t[i]?{...t[i],...r[i]}:{...r[i]}}),C=t,(e||I)&&localStorage.setItem("lib$",JSON.stringify(C))};if(new URL(import.meta.url).searchParams.has("global")){I=!0;let r=localStorage.getItem("lib$");if(r)try{C=JSON.parse(r)}catch{}}F.t$=u;var E="\u275E";u.got({ApiErr:{zh_CN:"\u987B\u6B63\u786E\u8BBE\u7F6Eapi",en_US:"proper api required"},Continue:{zh_CN:"\u7EE7\u7EED"},Remove:{zh_CN:"\u5220\u9664\u6B64\u8BB0\u5F55\uFF1F",en_US:"Remove this log?"},Copy:{zh_CN:"\u62F7\u8D1D"},Delete:{zh_CN:"\u5220\u9664"},Session:{zh_CN:"\u7EED\u804A\u6A21\u5F0F\uFF0C\u9650{{0}}\u5B57\u7B26",en_US:"session continue, limits to {{0}} character(s)"}});var R=class extends W{constructor(){super(),this.lang="zh_CN",this._current=-1}firstUpdated(){let e=this.for&&p(this.for)||this.renderRoot.host.parentNode;this._stage=e,this.api=(e.host||e).api||globalThis.deAPI||L}ask(e,t){let{cells:i=[],api:a=L}=this,s=!isNaN(t)&&t<i.length-1?t:-1;this._current=s,this._asking=e,s>-1&&(i[s].content=e,i[s+1]={role:"assistant",style:"busying",content:E});let l={role:"user",content:e},h=(n,c)=>{this._cancel=void 0,s>-1?(i[s+1]=n,c<0?i[s+1].style="err":delete i[s+1].style):i.push(l,n),this._asking="",this._waiting=[],this.cells=i.slice(0),c!=-1&&this.notify(`de-${c<-1?"new":"changed"}`)},{url:o,streaming:m,headers:b,got:f}=a;if(!o||!f){h({role:"assistant",content:u`${this.lang}ApiErr`},-1);return}this._waiting=[E];let x=i.slice(0,s>-1?s+1:void 0).concat(s===-1?[l]:[]).map(n=>{if(n.style&&delete n.style,!/err/.test(n.role))return n}).filter(n=>!!n);V(x,(n,c,y)=>{this._cancel=y;let{fin:$=!c,err:w,cell:S}=f(n,c),B=typeof $=="number"&&$<0,j=`assistant${w||B?" err":""}`;if(w&&this.renderRoot.host.classList.add("fin"),!c||w){h({role:j,...S,...w?{content:d`[ERR] ${w}`}:{}},w?-2:0);return}let{_waiting:v}=this;v||(v=[]);let T=S&&S.content;if(v.length==0||v[0]==E?v=[T]:v.push(T),$!==!1){h({role:j,...S,content:v.join("")},w||B?-3:0);return}this._waiting=v.slice(0),s>-1&&(i[s+1].content=this._waiting,this.requestUpdate())},{api:o,streaming:m,headers:b})}next(){if(this._waiting&&this._waiting.length>0)return;let{renderRoot:e}=this,t=p("#mysay",e);if(/^\s*$/.test(t.value)){t.focus();return}this.ask(t.value.trim()),this.input("")}input(e){let{renderRoot:t,_tid:i}=this;i&&clearTimeout(i);let a=p("#mysay",t);(e||typeof e=="string")&&(a.value=e.trim()),this._tid=setTimeout(()=>{t.host.classList.contains("fin")||p("#mysay",t).focus()},300)}active(){return this.cells?.length>0||this._waiting?.length>0}notify(e,t){(this._stage.host||this._stage).dispatchEvent(new CustomEvent(e,{detail:t}))}focus(){let{renderRoot:e}=this;this._stage&&this.notify("de-focus",e.host);let t=e.host.classList;t.contains("fin")&&t.remove("fin"),this.input()}_enter(e){e.key=="Enter"&&this.next()}_delete(e){let t=e.target;if(!t.parentElement.classList.contains("err")&&!confirm(u`${this.lang}Remove`))return;let{i:a}=t.dataset,s=parseInt(a,10);this._current>-1&&s<this._current&&(this._current-=1),this.cells.splice(s-1,2),this.cells.length>0?this.requestUpdate():(this._cancel?.(),this.renderRoot.host.parentNode.removeChild(this.renderRoot.host)),this.notify("de-changed")}_edit(e){let t=e.target,{i}=t.dataset,a=parseInt(i,10),s=this.cells[a];!s||(p("#mysay",this.renderRoot).value=s.content,this.focus())}_stop(e){this._cancel()}_regen(e){let t=e.target,{i}=t.dataset,a=parseInt(i,10),s=this.cells[a-1];!s||this.ask(s.content,a-1)}render(){let{max:e=4096}=this.api||{},{cells:t=[],_current:i,_asking:a,_waiting:s,_cancel:l}=this,h=t.length,o=JSON.stringify(t);return d`${h>0?t.map((m,b)=>{let{role:f,content:x,style:n}=m,c=b==h-1&&o.length<e&&!f.includes("err");return d`<div class="${f} ${n||""}">${x===E?d`<div id="dots">${E}</div>`:d`<p>${x}</p>`}${f.includes("assistant")?d`
${l?d`<a class="btn cancel" @click=${this._stop}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="red" class="bi bi-trash3" viewBox="0 0 16 16">
  <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z"/>
  <path d="M5 6.5A1.5 1.5 0 0 1 6.5 5h3A1.5 1.5 0 0 1 11 6.5v3A1.5 1.5 0 0 1 9.5 11h-3A1.5 1.5 0 0 1 5 9.5v-3z"/>
</svg></a>`:b!==i?d`<a class="btn regen" data-i="${b}" @click=${this._regen}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="red" class="bi bi-trash3" viewBox="0 0 16 16">
  <path fill-rule="evenodd" d="M8 3a5 5 0 1 1-4.546 2.914.5.5 0 0 0-.908-.417A6 6 0 1 0 8 2v1z"/>
  <path d="M8 4.466V.534a.25.25 0 0 0-.41-.192L5.23 2.308a.25.25 0 0 0 0 .384l2.36 1.966A.25.25 0 0 0 8 4.466z"/>
</svg></a>`:""}
              <a class="btn trash ${c?"":"r2"}" title="${u`${this.lang}Delete`}" data-i="${b}" @click=${this._delete}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="red" class="bi bi-trash3" viewBox="0 0 16 16">
  <path d="M6.5 1h3a.5.5 0 0 1 .5.5v1H6v-1a.5.5 0 0 1 .5-.5ZM11 2.5v-1A1.5 1.5 0 0 0 9.5 0h-3A1.5 1.5 0 0 0 5 1.5v1H2.506a.58.58 0 0 0-.01 0H1.5a.5.5 0 0 0 0 1h.538l.853 10.66A2 2 0 0 0 4.885 16h6.23a2 2 0 0 0 1.994-1.84l.853-10.66h.538a.5.5 0 0 0 0-1h-.995a.59.59 0 0 0-.01 0H11Zm1.958 1-.846 10.58a1 1 0 0 1-.997.92h-6.23a1 1 0 0 1-.997-.92L3.042 3.5h9.916Zm-7.487 1a.5.5 0 0 1 .528.47l.5 8.5a.5.5 0 0 1-.998.06L5 5.03a.5.5 0 0 1 .47-.53Zm5.058 0a.5.5 0 0 1 .47.53l-.5 8.5a.5.5 0 1 1-.998-.06l.5-8.5a.5.5 0 0 1 .528-.47ZM8 4.5a.5.5 0 0 1 .5.5v8.5a.5.5 0 0 1-1 0V5a.5.5 0 0 1 .5-.5Z"/>
</svg></a>${c?d`<a class="btn continue" title="${u`${this.lang}Continue`} " @click=${()=>this.focus()}>
<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-chat-square-quote-fill" viewBox="0 0 16 16">
  <path d="M0 2a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2h-2.5a1 1 0 0 0-.8.4l-1.9 2.533a1 1 0 0 1-1.6 0L5.3 12.4a1 1 0 0 0-.8-.4H2a2 2 0 0 1-2-2V2zm7.194 2.766a1.688 1.688 0 0 0-.227-.272 1.467 1.467 0 0 0-.469-.324l-.008-.004A1.785 1.785 0 0 0 5.734 4C4.776 4 4 4.746 4 5.667c0 .92.776 1.666 1.734 1.666.343 0 .662-.095.931-.26-.137.389-.39.804-.81 1.22a.405.405 0 0 0 .011.59c.173.16.447.155.614-.01 1.334-1.329 1.37-2.758.941-3.706a2.461 2.461 0 0 0-.227-.4zM11 7.073c-.136.389-.39.804-.81 1.22a.405.405 0 0 0 .012.59c.172.16.446.155.613-.01 1.334-1.329 1.37-2.758.942-3.706a2.466 2.466 0 0 0-.228-.4 1.686 1.686 0 0 0-.227-.273 1.466 1.466 0 0 0-.469-.324l-.008-.004A1.785 1.785 0 0 0 10.07 4c-.957 0-1.734.746-1.734 1.667 0 .92.777 1.666 1.734 1.666.343 0 .662-.095.931-.26z"/>
          ...
          </a>`:""}<a class="btn copix" title="${u`${this.lang}Copy`}" @click=${()=>{H(x)}}></a>`:f.includes("user")?d`<a class="btn edit" data-i="${b}" @click=${this._edit}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
  ...
  <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z"/>
      ...
      <input autofocus type="search" id="mysay" class="rl" @keypress=${this._enter} placeholder="${h>0?u`${this.lang}${e-o.length}Session`:""}">
...
<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-return-left" viewBox="0 0 16 16">
  ...
  `);customElements.define("de-chat",R);var O=document,q=O.createElement("a"),M=class extends Y{constructor(){super(),this._available=!0,this._ik=g("ik"),this.api=L}firstUpdated(){let e=this.renderRoot.host;e.addEventListener("de-changed",()=>{let i=[];k("de-chat",this.renderRoot,a=>{a.cells?.length>0&&i.push(a.cells)}),g("ai",JSON.stringify(i)),this._available=i.length>0}),e.addEventListener("de-new",()=>{this.new()});let t=g("ai");t?this.load(t):this._available=!1,e.addEventListener("de-focus",i=>{k("de-chat",this.renderRoot,a=>{a!=i.detail&&a.classList.add("fin")})}),this.new(),window.addEventListener("beforeunload",i=>{let a=!1;if(k("de-chat",this.renderRoot,s=>{a||s._waiting&&s._waiting.length>0&&(a=!0)}),a)return i.preventDefault(),i.returnValue="\u8FD8\u6709\u5BF9\u8BDD\u6CA1\u6709\u7ED3\u675F\uFF0C\u786E\u5B9A\u79BB\u5F00\uFF1F"},{capture:!0})}load(e){try{let t=JSON.parse(e);if(!t||t.length==0)return!1;let i=p("#ia",this.renderRoot),a=i.previousElementSibling;return a&&!a.active()&&(i=a),t.forEach(s=>{let l=O.createElement("de-chat");l.className="fin",l.cells=s,this.renderRoot.insertBefore(l,i)}),this._available=!0,!0}catch(t){console.error(t)}return!1}new(){let e=p("#ia",this.renderRoot),t=e.previousElementSibling;if(!t||t.active()){let i=O.createElement("de-chat");this.renderRoot.insertBefore(i,e),t=i}t.focus()}_local(e){let t=prompt(`\u4F7F\u7528\u81EA\u5DF1\u7684OpenAI Key
  \u3010\u6CE8\u610F\u3011\u672C\u7AD9\u4E0D\u5B58\u50A8\uFF0C\u98CE\u9669\u81EA\u8D1F\u3002\uFF08\u5EFA\u8BAE\u5B58\u670D\u52A1\u5668\uFF09`);if(!!t){if(t==="CLEAR"){g("ik",!1),this._ik="";return}this._ik=btoa(t.trim()),g("ik",btoa(t.trim()))}}clear(){!g("ai")||!confirm("\u786E\u8BA4\u8981\u6E05\u9664\u6240\u6709\u8BB0\u5F55\uFF1F")||(k("de-chat",this.renderRoot,e=>{!e.active()||e.parentNode.removeChild(e)}),g("ai",!1),this._available=!1,this.new())}_loadx=e=>{let t=e.target.files;if(!window.FileReader||!t||t.length==0)return;let i=new FileReader;i.onload=a=>{let s=a.target.result;this.load(s)&&this.renderRoot.host.dispatchEvent(new CustomEvent("de-changed",{})),this.new()},i.readAsText(t[0])};download(){let e=g("ai");if(!e){alert("\u6CA1\u6709\u8BB0\u5F55\u6570\u636E");return}let t=new Date;q.download=`deqi-ai-chat_${[t.getFullYear(),`0${t.getMonth()+1}`.slice(-2),`0${t.getDate()}`.slice(-2)].join("")}.json`,q.href=`data:application/json;base64,${btoa(unescape(encodeURIComponent(e)))}`,q.click()}render(){return X`<div id="ia" style="text-align: center;position:relative;display: flex; align-items: center;">
...
</div><input id="myfile" type="file" accept=".json" style="display:none" @change=${this._loadx}>`}};_(M,"properties",{api:{type:Object},_available:{type:Boolean},_ik:{type:String}}),_(M,"styles",K`
:host {
  display: block;
  width: 100%;
  margin: 2rem auto;
