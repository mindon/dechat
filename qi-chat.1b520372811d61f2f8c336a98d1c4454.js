var U=Object.defineProperty;var Z=(s,t,e)=>t in s?U(s,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):s[t]=e;var _=(s,t,e)=>(Z(s,typeof t!="symbol"?t+"":t,e),e);import{css as K,html as X,LitElement as Y}from"https://cdn.jsdelivr.net/gh/lit/dist@2/core/lit-core.min.js";var z=globalThis||{};function p(s,t,e){t instanceof Function&&(e=t,t=document);let i=(t||document).querySelector(s);return e&&i&&i.addEventListener("click",e),i}z.q$=p;function k(s,t,e){t instanceof Function&&(e=t,t=document);let i=(t||document).querySelectorAll(s);return e&&[].slice.apply(i).forEach(e),i}z.q$$=k;var D=document;function A(s,t){let e,i=s,a=!i.tagName;a?(e=D.createElement("textarea"),e.value=i,e.readOnly=!0,e.style.top="0",e.style.left="0",e.style.height="1px",e.style.width="1px",e.style.position="fixed",D.body.appendChild(e)):(e=i,i=e.value),e.setSelectionRange(0,Number.MAX_VALUE),e.select(),setTimeout(()=>{e.focus();try{let r=D.execCommand("copy");t&&t(r)}catch(r){t&&t(!1,r)}a&&D.body.removeChild(e)},50)}function H(s,t){try{navigator.permissions.query({name:"clipboard-write"}).then(e=>{if(e.state!=="granted"&&e.state!=="prompt"){A(s,t);return}let i=navigator.clipboard;if(!i){A(s,t);return}i.writeText(s.value||s||"").then(a=>{t&&t(a)},a=>{A(s,t)})}).catch(e=>{A(s,t)})}catch{A(s,t)}}z.copix=H;async function V(s,t,{api:e,headers:i,streaming:a}){let r=JSON.stringify(s),l=z.AbortController?new AbortController:{},h=l.signal,o=await fetch(e,{method:"POST",signal:h,mode:"cors",headers:[["Content-Type","application/json"]].concat((i instanceof Function?i():i)||[]),body:r});if(o.status>=400){let n=await o.text();if(n.startsWith("{"))try{let c=JSON.parse(n),{error:y={},err:$=""}=c;$?n=$:typeof y=="string"?n=y:y.message&&(n=y.message)}catch{}t({err:`${o.status}: ${n||o.statusText}: `});return}if(!a){t(await o.json());return}let b=o.body.pipeThrough(new TextDecoderStream).getReader(),f=!1,x=()=>{l.abort?.(),f=!0,t({err:"~canceled"},a)};for(;!f;){let{value:n,done:c}=await b.read();if(c)break;t(n.split("data: "),a,x)}}z.po$t=V;function g(s,t){if(t===void 0)return localStorage.getItem(s);if(t===!1){localStorage.removeItem(s);return}localStorage.setItem(s,t)}z.data$=g;var J="[DONE]",L={url:"/chat?stream",streaming:!0,headers:()=>{let s=new URL(`about:blank${location.search}`).searchParams,t=[],e="x-openai",i=g("ik");if(i&&i.length>8&&t.push([`${e}-key`,i]),s.has("vip")){let r=s.get("vip");r&&/^\w{1,16}$/.test(r)&&t.push([`${e}-vip`,r]),s.delete("vip")}let a=s.toString();return a&&t.push([`${e}-args`,btoa(a)]),t},got:(s,t)=>{if(s&&s.err)return{err:s.err};if(!t){let{choices:a=[]}=s||{},{content:r}=a.length>0&&a[0]||{};return r?{cell:{content:r}}:{err:s.error&&s.error.message||"unknown error"}}let e=!1,i=s.map(a=>{if(!a)return"";if(!a.startsWith("{"))return e=a.trim()==J,e?"":a;let r=JSON.parse(a.trim()),{error:l={}}=r;return l.message?(e=-2,`[!ERR] ${l.message}`):r}).map(a=>a?typeof a=="string"?a:a.choices&&a.choices[0].delta.content||"":"").join("");return{fin:e,cell:{content:i}}}};import{css as P,html as d,LitElement as W}from"https://cdn.jsdelivr.net/gh/lit/dist@2/core/lit-core.min.js";var N=/\{\{(\d+)\}\}/g,F=globalThis,C={};function u(s,...t){let e=C||{},i="";if(t.length<=1){i=s.join("");let o=e[i];return!o||t.length===0?i.replace(N,""):(o[t[0]]||i).replace(N,"")}let a=0;s.forEach((o,m)=>{o.length!==0&&(a=m)});let r=t.slice(1,a),l=s.slice(a);if(t.slice(a).forEach((o,m)=>{l.splice(m+1,0,o)}),i=l.join(""),t.length===0)return i.replace(N,"");let h=e[i];return!h||!h[t[0]]?i:h[t[0]].replace(N,(o,m)=>r[parseInt(m,10)]||"")}var I=!1;u.got=(s,t=!1)=>{let e=C||{};Object.keys(s).forEach(i=>{e[i]=e[i]?{...e[i],...s[i]}:{...s[i]}}),C=e,(t||I)&&localStorage.setItem("lib$",JSON.stringify(C))};if(new URL(import.meta.url).searchParams.has("global")){I=!0;let s=localStorage.getItem("lib$");if(s)try{C=JSON.parse(s)}catch{}}F.t$=u;var E="\u275E";u.got({ApiErr:{zh_CN:"\u987B\u6B63\u786E\u8BBE\u7F6Eapi",en_US:"proper api required"},Continue:{zh_CN:"\u7EE7\u7EED"},Remove:{zh_CN:"\u5220\u9664\u6B64\u8BB0\u5F55\uFF1F",en_US:"Remove this log?"},Copy:{zh_CN:"\u62F7\u8D1D"},Delete:{zh_CN:"\u5220\u9664"},Session:{zh_CN:"\u7EED\u804A\u6A21\u5F0F\uFF0C\u9650{{0}}\u5B57\u7B26",en_US:"session continue, limits to {{0}} character(s)"}});var R=class extends W{constructor(){super(),this.lang="zh_CN",this._current=-1}firstUpdated(){let t=this.for&&p(this.for)||this.renderRoot.host.parentNode;this._stage=t,this.api=(t.host||t).api||globalThis.deAPI||L}ask(t,e){let{cells:i=[],api:a=L}=this,r=!isNaN(e)&&e<i.length-1?e:-1;this._current=r,this._asking=t,r>-1&&(i[r].content=t,i[r+1]={role:"assistant",style:"busying",content:E});let l={role:"user",content:t},h=(n,c)=>{this._cancel=void 0,r>-1?(i[r+1]=n,c<0?i[r+1].style="err":delete i[r+1].style):i.push(l,n),this._asking="",this._waiting=[],this.cells=i.slice(0),c!=-1&&this.notify(`de-${c<-1?"new":"changed"}`)},{url:o,streaming:m,headers:b,got:f}=a;if(!o||!f){h({role:"assistant",content:u`${this.lang}ApiErr`},-1);return}this._waiting=[E];let x=i.slice(0,r>-1?r+1:void 0).concat(r===-1?[l]:[]).map(n=>{if(n.style&&delete n.style,!/err/.test(n.role))return n}).filter(n=>!!n);V(x,(n,c,y)=>{this._cancel=y;let{fin:$=!c,err:w,cell:S}=f(n,c),B=typeof $=="number"&&$<0,j=`assistant${w||B?" err":""}`;if(w&&this.renderRoot.host.classList.add("fin"),!c||w){h({role:j,...S,...w?{content:d`[ERR] ${w}`}:{}},w?-2:0);return}let{_waiting:v}=this;v||(v=[]);let T=S&&S.content;if(v.length==0||v[0]==E?v=[T]:v.push(T),$!==!1){h({role:j,...S,content:v.join("")},w||B?-3:0);return}this._waiting=v.slice(0),r>-1&&(i[r+1].content=this._waiting,this.requestUpdate())},{api:o,streaming:m,headers:b})}next(){if(this._waiting&&this._waiting.length>0)return;let{renderRoot:t}=this,e=p("#mysay",t);if(/^\s*$/.test(e.value)){e.focus();return}this.ask(e.value.trim()),this.input("")}input(t){let{renderRoot:e,_tid:i}=this;i&&clearTimeout(i);let a=p("#mysay",e);(t||typeof t=="string")&&(a.value=t.trim()),this._tid=setTimeout(()=>{e.host.classList.contains("fin")||p("#mysay",e).focus()},300)}active(){return this.cells?.length>0||this._waiting?.length>0}notify(t,e){(this._stage.host||this._stage).dispatchEvent(new CustomEvent(t,{detail:e}))}focus(){let{renderRoot:t}=this;this._stage&&this.notify("de-focus",t.host);let e=t.host.classList;e.contains("fin")&&e.remove("fin"),this.input()}_enter(t){t.key=="Enter"&&this.next()}_delete(t){let e=t.target;if(!e.parentElement.classList.contains("err")&&!confirm(u`${this.lang}Remove`))return;let{i:a}=e.dataset,r=parseInt(a,10);this._current>-1&&r<this._current&&(this._current-=1),this.cells.splice(r-1,2),this.cells.length>0?this.requestUpdate():(this._cancel&&this._cancel(),this.renderRoot.host.parentNode.removeChild(this.renderRoot.host)),this.notify("de-changed")}_edit(t){let e=t.target,{i}=e.dataset,a=parseInt(i,10),r=this.cells[a];!r||(p("#mysay",this.renderRoot).value=r.content,this.focus())}_stop(t){this._cancel()}_regen(t){let e=t.target,{i}=e.dataset,a=parseInt(i,10),r=this.cells[a-1];!r||this.ask(r.content,a-1)}render(){let{max:t=4096}=this.api||{},{cells:e=[],_current:i,_asking:a,_waiting:r,_cancel:l}=this,h=e.length,o=JSON.stringify(e);return d`${h>0?e.map((m,b)=>{let{role:f,content:x,style:n}=m,c=b==h-1&&o.length<t&&!f.includes("err");return d`<div class="${f} ${n||""}">${x===E?d`<div id="dots">${E}</div>`:d`<p>${x}</p>`}${f.includes("assistant")?d`
...
</svg></a>`:""}</div>`}):""}${i===-1&&a?d`<div class="user"><p>${a}</p></div>`:""}${i===-1&&r&&r.length>0?d`<div class="assistant">${r[0]===E?d`<div id="dots">${r}</div>`:d`<p>${r}</p>`}</div>`:""}<div class="next ${h>0?"has":""}">
      <input autofocus type="search" id="mysay" class="rl" @keypress=${this._enter} placeholder="${h>0?u`${this.lang}${t-o.length}Session`:""}">
      <a class="btn rr" ?disabled=${!!(r&&r.length>0)} role="button" @click=${this.next}>
<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-return-left" viewBox="0 0 16 16">
  ...
  `);customElements.define("de-chat",R);var O=document,q=O.createElement("a"),M=class extends Y{constructor(){super(),this._available=!0,this._ik=g("ik"),this.api=L}firstUpdated(){let t=this.renderRoot.host;t.addEventListener("de-changed",()=>{let i=[];k("de-chat",this.renderRoot,a=>{a.cells?.length>0&&i.push(a.cells)}),g("ai",JSON.stringify(i)),this._available=i.length>0}),t.addEventListener("de-new",()=>{this.new()});let e=g("ai");e?this.load(e):this._available=!1,t.addEventListener("de-focus",i=>{k("de-chat",this.renderRoot,a=>{a!=i.detail&&a.classList.add("fin")})}),this.new(),window.addEventListener("beforeunload",i=>{let a=!1;if(k("de-chat",this.renderRoot,r=>{a||r._waiting&&r._waiting.length>0&&(a=!0)}),a)return i.preventDefault(),i.returnValue="\u8FD8\u6709\u5BF9\u8BDD\u6CA1\u6709\u7ED3\u675F\uFF0C\u786E\u5B9A\u79BB\u5F00\uFF1F"},{capture:!0})}load(t){try{let e=JSON.parse(t);if(!e||e.length==0)return!1;let i=p("#ia",this.renderRoot),a=i.previousElementSibling;return a&&!a.active()&&(i=a),e.forEach(r=>{let l=O.createElement("de-chat");l.className="fin",l.cells=r,this.renderRoot.insertBefore(l,i)}),this._available=!0,!0}catch(e){console.error(e)}return!1}new(){let t=p("#ia",this.renderRoot),e=t.previousElementSibling;if(!e||e.active()){let i=O.createElement("de-chat");this.renderRoot.insertBefore(i,t),e=i}e.focus()}_local(t){let e=prompt(`\u4F7F\u7528\u81EA\u5DF1\u7684OpenAI Key
  \u3010\u6CE8\u610F\u3011\u672C\u7AD9\u4E0D\u5B58\u50A8\uFF0C\u98CE\u9669\u81EA\u8D1F\u3002\uFF08\u5EFA\u8BAE\u5B58\u670D\u52A1\u5668\uFF09`);if(!!e){if(e==="CLEAR"){g("ik",!1),this._ik="";return}this._ik=btoa(e.trim()),g("ik",btoa(e.trim()))}}clear(){!g("ai")||!confirm("\u786E\u8BA4\u8981\u6E05\u9664\u6240\u6709\u8BB0\u5F55\uFF1F")||(k("de-chat",this.renderRoot,t=>{!t.active()||t.parentNode.removeChild(t)}),g("ai",!1),this._available=!1,this.new())}_loadx=t=>{let e=t.target.files;if(!window.FileReader||!e||e.length==0)return;let i=new FileReader;i.onload=a=>{let r=a.target.result;this.load(r)&&this.renderRoot.host.dispatchEvent(new CustomEvent("de-changed",{})),this.new()},i.readAsText(e[0])};download(){let t=g("ai");if(!t){alert("\u6CA1\u6709\u8BB0\u5F55\u6570\u636E");return}let e=new Date;q.download=`deqi-ai-chat_${[e.getFullYear(),`0${e.getMonth()+1}`.slice(-2),`0${e.getDate()}`.slice(-2)].join("")}.json`,q.href=`data:application/json;base64,${btoa(unescape(encodeURIComponent(t)))}`,q.click()}render(){return X`<div id="ia" style="text-align: center;position:relative;display: flex; align-items: center;">
