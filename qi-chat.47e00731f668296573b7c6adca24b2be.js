var U=Object.defineProperty;var Z=(r,t,e)=>t in r?U(r,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):r[t]=e;var _=(r,t,e)=>(Z(r,typeof t!="symbol"?t+"":t,e),e);import{css as K,html as X,LitElement as Y}from"https://cdn.jsdelivr.net/gh/lit/dist@2/core/lit-core.min.js";var z=globalThis||{};function p(r,t,e){t instanceof Function&&(e=t,t=document);let i=(t||document).querySelector(r);return e&&i&&i.addEventListener("click",e),i}z.q$=p;function k(r,t,e){t instanceof Function&&(e=t,t=document);let i=(t||document).querySelectorAll(r);return e&&[].slice.apply(i).forEach(e),i}z.q$$=k;var D=document;function A(r,t){let e,i=r,a=!i.tagName;a?(e=D.createElement("textarea"),e.value=i,e.readOnly=!0,e.style.top="0",e.style.left="0",e.style.height="1px",e.style.width="1px",e.style.position="fixed",D.body.appendChild(e)):(e=i,i=e.value),e.setSelectionRange(0,Number.MAX_VALUE),e.select(),setTimeout(()=>{e.focus();try{let s=D.execCommand("copy");t&&t(s)}catch(s){t&&t(!1,s)}a&&D.body.removeChild(e)},50)}function H(r,t){try{navigator.permissions.query({name:"clipboard-write"}).then(e=>{if(e.state!=="granted"&&e.state!=="prompt"){A(r,t);return}let i=navigator.clipboard;if(!i){A(r,t);return}i.writeText(r.value||r||"").then(a=>{t&&t(a)},a=>{A(r,t)})}).catch(e=>{A(r,t)})}catch{A(r,t)}}z.copix=H;async function V(r,t,{api:e,headers:i,streaming:a}){let s=JSON.stringify(r),l=z.AbortController?new AbortController:{},h=l.signal,o=await fetch(e,{method:"POST",signal:h,mode:"cors",headers:[["Content-Type","application/json"]].concat((i instanceof Function?i():i)||[]),body:s});if(o.status>=400){let n=await o.text();if(n.startsWith("{"))try{let c=JSON.parse(n),{error:y={},err:$=""}=c;$?n=$:typeof y=="string"?n=y:y.message&&(n=y.message)}catch{}t({err:`${o.status}: ${n||o.statusText}: `});return}if(!a){t(await o.json());return}let b=o.body.pipeThrough(new TextDecoderStream).getReader(),f=!1,x=()=>{l.abort?.(),f=!0,t(['{"error":{"message":"~canceled"}}'],a)};for(;!f;){let{value:n,done:c}=await b.read();if(c)break;t(n.split("data: "),a,x)}}z.po$t=V;function g(r,t){if(t===void 0)return localStorage.getItem(r);if(t===!1){localStorage.removeItem(r);return}localStorage.setItem(r,t)}z.data$=g;var J="[DONE]",L={url:"/chat?stream",streaming:!0,headers:()=>{let r=new URL(`about:blank${location.search}`).searchParams,t=[],e="x-openai",i=g("ik");if(i&&i.length>8&&t.push([`${e}-key`,i]),r.has("vip")){let s=r.get("vip");s&&/^\w{1,16}$/.test(s)&&t.push([`${e}-vip`,s]),r.delete("vip")}let a=r.toString();return a&&t.push([`${e}-args`,btoa(a)]),t},got:(r,t)=>{if(r&&r.err)return{err:r.err};if(!t){let{choices:a=[]}=r||{},{content:s}=a.length>0&&a[0]||{};return s?{cell:{content:s}}:{err:r.error&&r.error.message||"unknown error"}}let e=!1,i=r.map(a=>{if(!a)return"";if(!a.startsWith("{"))return e=a.trim()==J,e?"":a;let s=JSON.parse(a.trim()),{error:l={}}=s;return l.message?(e=-2,`[!ERR] ${l.message}`):s}).map(a=>a?typeof a=="string"?a:a.choices&&a.choices[0].delta.content||"":"").join("");return{fin:e,cell:{content:i}}}};import{css as P,html as d,LitElement as W}from"https://cdn.jsdelivr.net/gh/lit/dist@2/core/lit-core.min.js";var N=/\{\{(\d+)\}\}/g,F=globalThis,C={};function u(r,...t){let e=C||{},i="";if(t.length<=1){i=r.join("");let o=e[i];return!o||t.length===0?i.replace(N,""):(o[t[0]]||i).replace(N,"")}let a=0;r.forEach((o,m)=>{o.length!==0&&(a=m)});let s=t.slice(1,a),l=r.slice(a);if(t.slice(a).forEach((o,m)=>{l.splice(m+1,0,o)}),i=l.join(""),t.length===0)return i.replace(N,"");let h=e[i];return!h||!h[t[0]]?i:h[t[0]].replace(N,(o,m)=>s[parseInt(m,10)]||"")}var I=!1;u.got=(r,t=!1)=>{let e=C||{};Object.keys(r).forEach(i=>{e[i]=e[i]?{...e[i],...r[i]}:{...r[i]}}),C=e,(t||I)&&localStorage.setItem("lib$",JSON.stringify(C))};if(new URL(import.meta.url).searchParams.has("global")){I=!0;let r=localStorage.getItem("lib$");if(r)try{C=JSON.parse(r)}catch{}}F.t$=u;var E="\u275E";u.got({ApiErr:{zh_CN:"\u987B\u6B63\u786E\u8BBE\u7F6Eapi",en_US:"proper api required"},Continue:{zh_CN:"\u7EE7\u7EED"},Remove:{zh_CN:"\u5220\u9664\u6B64\u8BB0\u5F55\uFF1F",en_US:"Remove this log?"},Copy:{zh_CN:"\u62F7\u8D1D"},Delete:{zh_CN:"\u5220\u9664"},Session:{zh_CN:"\u7EED\u804A\u6A21\u5F0F\uFF0C\u9650{{0}}\u5B57\u7B26",en_US:"session continue, limits to {{0}} character(s)"}});var R=class extends W{constructor(){super(),this.lang="zh_CN",this._current=-1}firstUpdated(){let t=this.for&&p(this.for)||this.renderRoot.host.parentNode;this._stage=t,this.api=(t.host||t).api||globalThis.deAPI||L}ask(t,e){let{cells:i=[],api:a=L}=this,s=!isNaN(e)&&e<i.length-1?e:-1;this._current=s,this._asking=t,s>-1&&(i[s].content=t,i[s+1]={role:"assistant",style:"busying",content:E});let l={role:"user",content:t},h=(n,c)=>{this._cancel=void 0,s>-1?(i[s+1]=n,c<0?i[s+1].style="err":delete i[s+1].style):i.push(l,n),this._asking="",this._waiting=[],this.cells=i.slice(0),c!=-1&&this.notify(`de-${c<-1?"new":"changed"}`)},{url:o,streaming:m,headers:b,got:f}=a;if(!o||!f){h({role:"assistant",content:u`${this.lang}ApiErr`},-1);return}this._waiting=[E];let x=i.slice(0,s>-1?s+1:void 0).concat(s===-1?[l]:[]).map(n=>{if(n.style&&delete n.style,!/err/.test(n.role))return n}).filter(n=>!!n);V(x,(n,c,y)=>{this._cancel=y;let{fin:$=!c,err:w,cell:S}=f(n,c),B=typeof $=="number"&&$<0,j=`assistant${w||B?" err":""}`;if(w&&this.renderRoot.host.classList.add("fin"),!c||w){h({role:j,...S,...w?{content:d`[ERR] ${w}`}:{}},w?-2:0);return}let{_waiting:v}=this;v||(v=[]);let T=S&&S.content;if(v.length==0||v[0]==E?v=[T]:v.push(T),$!==!1){h({role:j,...S,content:v.join("")},w||B?-3:0);return}this._waiting=v.slice(0),s>-1&&(i[s+1].content=this._waiting,this.requestUpdate())},{api:o,streaming:m,headers:b})}next(){if(this._waiting&&this._waiting.length>0)return;let{renderRoot:t}=this,e=p("#mysay",t);if(/^\s*$/.test(e.value)){e.focus();return}this.ask(e.value.trim()),this.input("")}input(t){let{renderRoot:e,_tid:i}=this;i&&clearTimeout(i);let a=p("#mysay",e);(t||typeof t=="string")&&(a.value=t.trim()),this._tid=setTimeout(()=>{e.host.classList.contains("fin")||p("#mysay",e).focus()},300)}active(){return this.cells?.length>0||this._waiting?.length>0}notify(t,e){(this._stage.host||this._stage).dispatchEvent(new CustomEvent(t,{detail:e}))}focus(){let{renderRoot:t}=this;this._stage&&this.notify("de-focus",t.host);let e=t.host.classList;e.contains("fin")&&e.remove("fin"),this.input()}_enter(t){t.key=="Enter"&&this.next()}_delete(t){let e=t.target;if(!e.parentElement.classList.contains("err")&&!confirm(u`${this.lang}Remove`))return;let{i:a}=e.dataset,s=parseInt(a,10);this._current>-1&&s<this._current&&(this._current-=1),this.cells.splice(s-1,2),this.cells.length>0?this.requestUpdate():(this._cancel&&this._cancel(),this.renderRoot.host.parentNode.removeChild(this.renderRoot.host)),this.notify("de-changed")}_edit(t){let e=t.target,{i}=e.dataset,a=parseInt(i,10),s=this.cells[a];!s||(p("#mysay",this.renderRoot).value=s.content,this.focus())}_stop(t){this._cancel()}_regen(t){let e=t.target,{i}=e.dataset,a=parseInt(i,10),s=this.cells[a-1];!s||this.ask(s.content,a-1)}render(){let{max:t=4096}=this.api||{},{cells:e=[],_current:i,_asking:a,_waiting:s,_cancel:l}=this,h=e.length,o=JSON.stringify(e);return d`${h>0?e.map((m,b)=>{let{role:f,content:x,style:n}=m,c=b==h-1&&o.length<t&&!f.includes("err");return d`<div class="${f} ${n||""}">${x===E?d`<div id="dots">${E}</div>`:d`<p>${x}</p>`}${f.includes("assistant")?d`
